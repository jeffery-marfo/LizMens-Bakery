...
//       const response = await fetch(`https://api.sailrides.co/v1/deliveries/${trackingId}`, {
//         method: 'GET',
//         headers: {
...
//     if (status === 'in_progress' || status === 'arriving') return <Truck size={20} />;
...
//           </h1>
//           <p className="text-sm leading-relaxed text-gray-600 sm:text-base max-w-2xl mx-auto">
//             Fast, reliable delivery to your doorstep. Track your order in real-time.
//           </p>
//         </div>
...
//             <div className="bg-white/85 rounded-2xl border border-black/10 shadow-sm backdrop-blur-sm p-6 mb-6">
//               <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
//                 <Package className="text-[#ff9500]" size={24} />
//                 Track Your Delivery
//               </h2>
...
//                       className="px-6 py-2.5 rounded-lg bg-[#ff9500] text-white text-sm font-semibold hover:bg-[#e68600] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
//                     >
//                       {isLoading ? (
//                         <>
...
//                 {deliveryStatus && (
//                   <div className="mt-6 p-4 bg-gray-50 rounded-lg border border-black/5">
//                     <div className="flex items-center justify-between mb-4">
//                       <div className="flex items-center gap-3">
//                         {getStatusIcon(deliveryStatus.status)}
//                         <div>
//                           <div className="font-semibold text-gray-900">Delivery Status</div>
//                           <span className={`inline-block px-3 py-1 rounded-full text-xs font-semibold mt-1 ${getStatusColor(deliveryStatus.status)}`}>
...
//                       <div className="mt-4 p-3 bg-white rounded-lg border border-black/5">
//                         <div className="text-sm font-semibold text-gray-900 mb-2">Driver Information</div>
//                         <div className="text-sm text-gray-600 space-y-1">
//                           <div>Name: {deliveryStatus.driver.name}</div>
//                           <div>Phone: {deliveryStatus.driver.phone}</div>
//                           {deliveryStatus.driver.vehicle && (
//                             <div>Vehicle: {deliveryStatus.driver.vehicle}</div>
//                           )}
//                           {deliveryStatus.driver.plateNumber && (
//                             <div>Plate: {deliveryStatus.driver.plateNumber}</div>
//                           )}
//                         </div>
//                       </div>
//                     )}
...
//                         className="mt-4 inline-flex items-center gap-2 text-sm font-semibold text-[#ff9500] hover:text-[#e68600] transition-colors"
//                       >
//                         <Navigation size={16} />
...
//                       <div>Created: {new Date(deliveryStatus.createdAt).toLocaleString()}</div>
//                       {deliveryStatus.updatedAt && (
//                         <div>Last Updated: {new Date(deliveryStatus.updatedAt).toLocaleString()}</div>
//                       )}
//                     </div>
//                   </div>
//                 )}
...
//             {/* Delivery Zones */}
//             <div className="bg-white/85 rounded-2xl border border-black/10 shadow-sm backdrop-blur-sm p-6">
...
//                   <div>
//                     <div className="font-semibold text-gray-900">Accra Metro</div>
//                     <div className="text-xs">Greater Accra Region</div>
//                   </div>
//                 </div>
//                 <div className="flex items-start gap-2">
//                   <CheckCircle className="text-green-500 mt-0.5" size={16} />
...
//                     <div className="text-xs">Ashanti Region</div>
//                   </div>
//                 </div>
...
//             {/* Delivery Partners */}
//             <div className="bg-white/85 rounded-2xl border border-black/10 shadow-sm backdrop-blur-sm p-6">
//               <h3 className="text-lg font-bold text-gray-900 mb-4">Delivery Partners</h3>
//               <div className="space-y-3">
//                 <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
//                   <span className="text-sm font-semibold text-gray-900">Bolt</span>
//                   <span className="text-xs text-gray-500">Available</span>
//                 </div>
//                 <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
//                   <span className="text-sm font-semibold text-gray-900">Uber</span>
//                   <span className="text-xs text-gray-500">Available</span>
//                 </div>
//                 <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
//                   <span className="text-sm font-semibold text-gray-900">Yango</span>
//                   <span className="text-xs text-gray-500">Available</span>
//                 </div>
//               </div>
//             </div>
...
//             <div className="bg-white/85 rounded-2xl border border-black/10 shadow-sm backdrop-blur-sm p-6">
//               <h3 className="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
//                 <Phone className="text-[#ff9500]" size={20} />
//                 Need Help?
//               </h3>
//               <div className="space-y-3 text-sm">
//                 <div>
//                   <div className="font-semibold text-gray-900 mb-1">Contact Us</div>
//                   <div className="text-gray-600">0244 097 094</div>
//                   <div className="text-gray-600">020 572 1817</div>
//                 </div>
//                 <div>
//                   <div className="font-semibold text-gray-900 mb-1">Location</div>
//                   <div className="text-gray-600">KAE DABI HOUSE</div>
//                   <div className="text-gray-600">Teshie, Aboma, Accra</div>
//                 </div>
//               </div>
//             </div>
//           </div>
...
//               Get your order delivered quickly. Average delivery time: 15-30 minutes depending on location.
//             </p>
//           </div>
...
//             </div>
//             <p className="text-sm text-gray-600">
//               Track your delivery in real-time. See exactly where your order is and when it will arrive.
//             </p>
//           </div>
...
//               </div>
//               <h3 className="text-lg font-bold text-gray-900">Multiple Providers</h3>
//             </div>
//             <p className="text-sm text-gray-600">
//               We work with Bolt, Uber, and Yango to ensure the best delivery options and prices for you.
//             </p>
//           </div>
//         </div>

//         {/* CTA Section */}
//         <div className="bg-white/85 rounded-2xl border border-black/10 shadow-sm backdrop-blur-sm p-6 text-center">
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="flex flex-col lg:flex-row gap-6 mb-8 w-full">
                  ...
                  <div className="mt-6 p-4 bg-gray-50 rounded-lg border border-black/5 w-full">
                    ...
                    {deliveryStatus.driver && (
                      <div className="mt-4 p-3 bg-white rounded-lg border border-black/5 w-full">
                        <div className="text-sm font-semibold text-gray-900 mb-2">Driver Information</div>
                        <div className="text-sm text-gray-600 space-y-1">
                          <div className="break-words">Name: {deliveryStatus.driver.name}</div>
                          <div className="break-words">Phone: {deliveryStatus.driver.phone}</div>
                          {deliveryStatus.driver.vehicle && (
                            <div className="break-words">Vehicle: {deliveryStatus.driver.vehicle}</div>
                          )}
                          {deliveryStatus.driver.plateNumber && (
                            <div className="break-words">Plate: {deliveryStatus.driver.plateNumber}</div>
                          )}
                        </div>
                      </div>
                    )}
          ...
          <div className="w-full lg:w-1/3 space-y-6">
              ...
              <div className="space-y-3 text-sm text-gray-600">
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="font-semibold text-gray-900">Accra Metro</div>
                    <div className="text-xs text-gray-500">Greater Accra Region</div>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle className="text-green-500 mt-0.5 flex-shrink-0" size={16} />
            ...
            {/* Delivery Partners */}
            <div className="bg-white/85 rounded-2xl border border-black/10 shadow-sm backdrop-blur-sm p-4 sm:p-6 w-full">
              <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-4">Delivery Partners</h3>
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <span className="text-sm font-semibold text-gray-900">Bolt</span>
            ...
            <div className="bg-white/85 rounded-2xl border border-black/10 shadow-sm backdrop-blur-sm p-4 sm:p-6 w-full">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div>
                  <div className="font-semibold text-gray-900 mb-1">Location</div>
                  <div className="text-gray-600 break-words">KAE DABI HOUSE</div>
                  <div className="text-gray-600 break-words">Teshie, Aboma, Accra</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8 w-full">
          <div className="bg-white/85 rounded-2xl border border-black/10 shadow-sm backdrop-blur-sm p-4 sm:p-6 w-full">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-base sm:text-lg font-bold text-gray-900">Fast Delivery</h3>
            </div>
            <p className="text-sm text-gray-600">
              Get your order delivered quickly. Average delivery time: 15-30 minutes depending on location.
            </p>
          ...
          <div className="bg-white/85 rounded-2xl border border-black/10 shadow-sm backdrop-blur-sm p-4 sm:p-6 w-full">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-base sm:text-lg font-bold text-gray-900">Real-Time Tracking</h3>
            </div>
            <p className="text-sm text-gray-600">
              Track your delivery in real-time. See exactly where your order is and when it will arrive.
            </p>
          ...
          <div className="bg-white/85 rounded-2xl border border-black/10 shadow-sm backdrop-blur-sm p-4 sm:p-6 w-full sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-base sm:text-lg font-bold text-gray-900">Multiple Providers</h3>
            </div>
            <p className="text-sm text-gray-600">
              We work with Bolt, Uber, and Yango to ensure the best delivery options and prices for you.
            </p>
